...
function onload() {
    React.render(
        React.createElement(JudgeBot9000, {src: "http://o.aolcdn.com/hss/storage/adam/dde819906acab479c31e42b7bf468281/fear%20bot%20planet%201%20mac%20judging.jpg", 
                      time: 1000, 
...
},{"./lib/judgebot.jsx":2,"react":149}],2:[function(require,module,exports){
"use strict";
 ...
 */
var Flasher = React.createClass({displayName: "Flasher",
    render: function() {
        return React.createElement("img", React.__spread({className: "img-responsive center-block"},  this.props));
    }
});
...
var Label = React.createClass({displayName: "Label",
    ...
    render: function() {
        return (React.createElement("li", {className: "btn btn-default btn-block btn-lg", onClick: this.props.onClick}, this.props.value));
    }
});
...
var LabelList = React.createClass({displayName: "LabelList",
    ...
    render: function() {
        var labels = this.props.labels.map(function(label, index) {
            return React.createElement(Label, {value: label, key: index, onClick: this.props.onChoice.bind(null, index)});
        }.bind(this));

        return (React.createElement("ul", {className: "list-unstyled"}, labels));
    }
});
 ...
 */
var JudgeBot9000 = React.createClass({displayName: "JudgeBot9000",
    propTypes: {
    ...
    render: function() {
        ...
        if(this.state.flashing) {
            content = React.createElement(Flasher, {src: this.props.src, onLoad: this.onImageLoad});
        } else {
            content = React.createElement(LabelList, {labels: this.props.labels, onChoice: this.onChooseLabel()});
        }

        return (
            React.createElement("div", {className: "row"}, 
                React.createElement("div", {className: "col-xs-12"}, 
                    React.createElement("h3", {className: "text-center"}, "What kind of object is in this scene?")
                ), 
                React.createElement("div", {className: "col-xs-12"}, 
                    content
                )
...
//# sourceMappingURL=quickpic.js.map