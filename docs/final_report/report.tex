...
% The sections of the Introduction should be understandable by someone technically 
% competent with the area of the project but not familiar with this project. The 
% introduction includes:
% - a description of the feature to be supplied to the customer/user, or the problem 
%   you are solving
...
\begin{description}
	\item[PhotoHunter] A photo scanvenger hunt app \todo{}
	\item[QuickPic] Quick response game \todo{}
	\item[Researcher Interface] \todo{}
\end{description}
